...
public final class StudentDeleteHelper {
    ...
    private static void showInfo(String title, String msg) {Alert a = new Alert(Alert.AlertType.INFORMATION, msg, ButtonType.OK);a.setHeaderText(title);a.setTitle(title);UIUtil.applyLogoToAlert(a);a.showAndWait();}
    private static void showError(String title, String msg) {Alert a = new Alert(Alert.AlertType.ERROR, msg, ButtonType.OK);a.setHeaderText(title);a.setTitle(title);UIUtil.applyLogoToAlert(a);a.showAndWait();}
}
